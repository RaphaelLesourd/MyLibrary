...
class WelcomeControllerMainView: UIView {
    ...
    let loginButton = ActionButton(title: "Connexion", systemImage: "", imagePlacement: .leading, tintColor: .appTintColor)
    let signupButton = ActionButton(title: "Inscription", systemImage: "", imagePlacement: .leading, tintColor: .white)
    ...
    private func configureUI() {
        backgroundImage.image = UIImage(named: "welcomeScreenImage")
        titleLabel.text = "Bienvenue\ndans votre\nbibliothèque."
        termsOfUseLabel.text = "Conditions d'utilisation"
        socialMedialoginLabel.text = "Autres moyens de se connecter:"
